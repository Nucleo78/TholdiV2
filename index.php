...
<meta name="viewport" content="width=device-width, initial-scale=1.0">
	...
	<body>
        ...
        <div id="fond">
            ...
            <div class="SousParties">A.LE SECTEUR D’ACTIVITE : TRANSPORT MARITIME</div>
            <br>
            ...
            <div class="separationPartie">&nbsp</div>
            <div class="SousParties">B.LA SOCIETE THOLDI</div>
            <div class="CorpDeTexte">
                ...
                <br>
                <br>
                Le siège social de THOLDI est situé à Gennevilliers, en région parisienne, et ses zones d’activités sont implantées dans plusieurs installations portuaires européennes :
                <ul>
                    <li class="li">Gennevilliers (FR)</li>
                    <li class="li">Le Havre (FR)</li>
                    <li class="li">Marseille (FR)</li>
                    <li class="li">Hambourg (DE)</li>
                    <li class="li">Anvers (BL)</li>
                    <li class="li">Barcelone (ES)</li>
                    <li class="li">Rotterdam (NL)</li>
                    <li class="li">Gênes (IT)</li>
                </ul>
            </div>
            <div class="separationPartie">&nbsp</div>
        <div class="SousParties">C.MISSIONS ET METIERS</div>
        <div class="CorpDeTexte">
            Son activité principale consiste à :
            <ul>
                <li class="li">Gérer le déchargement et la réception des containeurs (contrôle de leur provenance et du transporteur maritime) ;
                <li class="li">Gérer le placement en zone de stockage temporaire ;
                <li class="li">Gérer le chargement des containeurs sur les remorques de transport routier ou de transport ferroviaire ;
                <li class="li">Gérer le processus d’acheminement de fret de « porte à porte ».
            </ul>
